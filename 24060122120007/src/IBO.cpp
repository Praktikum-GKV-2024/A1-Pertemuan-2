...
public:
    ...
    void start()
    {
        ...
        float positions[] = {
            0.f, 0.f, 1.0, 1.0, 1.0,   // A0 
            0.3f, 0.f, 1.0, 0.0, 0.0,  // A1 
            0.f, -0.3f, 1.0, 0.0, 0.0, // A2 
            -0.3f, 0.f, 1.0, 0.0, 0.0, // A3 
            0.f, 0.3f, 1.0, 0.0, 0.0,  // A4 
            0.5f, 0.f, 0.0, 1.0, 0.0,  // A5 
            0.f, -0.5f, 0.0, 1.0, 0.0, // A6 
            -0.5f, 0.f, 0.0, 1.0, 0.0, // A7 
            0.f, 0.5f, 0.0, 1.0, 0.0,  // A8 
            0.8f, 0.f, 0.0, 0.0, 1.0,  // A9 
            0.f, -0.8f, 0.0, 0.0, 1.0, // A10 
            -0.8f, 0.f, 0.0, 0.0, 1.0, // A11 
            0.f, 0.8f, 0.0, 0.0, 1.0   // A12 
        };
